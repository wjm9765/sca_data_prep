...
class ComedianEvent(BaseEvent):
    ...
    content: str = Field(
        ..., description="Verbatim transcript of speech OR description of the sound"
    )
    event_type: Literal[
        "speech",
        "vocal_sfx",
    ...
    delivery_tag: Optional[str] = Field(
        None, description="Style of delivery (e.g., 'yelling', 'whispering', 'deadpan')"
    )
...
class AudienceEvent(BaseEvent):
    ...
    content: str = Field(
        ..., description="Transcript of speech OR description of noise"
    )
...
class EnvironmentEvent(BaseEvent):
    ...
    content: str = Field(
        ...,
        description="Description of the sound (e.g., 'Glass breaking', 'Feedback squeal')",
    )
